...
export const privacySectionsEn = [
  ...
  {
    title: "11. Advertising (Adsterra and other third-party ads)",
    body: "Our website (https://hyphenjob.com) may display ads served by Adsterra and its partners (for example native banners). These providers may use cookies, pixels, or other identifiers to measure performance or show more relevant ads.\n\nYou can limit or clear cookies in your browser settings. Third-party ad services process data under their own privacy policies. We do not sell your personal data. For questions about ads on our site, contact hyphe.office@gmail.com.",
  },
  {

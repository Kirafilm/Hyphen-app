...
export type Messages = {
  ...
  profile: {
    ...
    menuTerms: string;
    menuContact: string;
    menuServicePage: string;
    menuMessages: string;
    menuFindTalent: string;
    menuAdmin: string;
    menuLogout: string;
  };
  login: {
  ...
  settings: {
    ...
    messageAlertsTitle: string;
    messageAlertsHint: string;
    accountTitle: string;
  ...
  home: {
    ...
    proFeatureBrowseCta: string;
    proFeatureCreateCta: string;
    howLabel: string;
    howTitle: string;
    howSubtitle: string;
  ...
  serviceProfile: {
    ...
    ownInboxCta: string;
    ownPageNotice: string;
    contactErrorTitle: string;
    contactErrorBody: string;
    notFoundTitle: string;
    notFoundBody: string;
    fallbackTitle: string;
    adminRemoveTitle: string;
    adminRemoveBody: string;
    adminRemoveAction: string;
    adminRemoving: string;
    adminRemovedTitle: string;
    adminRemovedBody: string;
  };
  serviceDirectory: {
    title: string;
    subtitle: string;
  ...
  serviceProfileEdit: {
    ...
    uploadCta: string;
    webOnlyUploadTitle: string;
    webOnlyUploadBody: string;
    webOnlyEditTitle: string;
    webOnlyEditBody: string;
    uploadErrorTitle: string;
    uploadErrorBody: string;
    uploadTooLargeTitle: string;
    uploadTooLargeBody: string;
    publishLabel: string;
    publishHint: string;
    saveCta: string;
    previewCta: string;
    saveAndPreviewCta: string;
    savedTitle: string;
    savedBody: string;

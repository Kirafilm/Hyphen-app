    ...
    copy: {
      "zh-HK": {
        ...
        sections: [
          ...
          {
            h: "廣告與其他",
            p: "網站部分頁面可能顯示第三方廣告，用以支援免費內容與平台營運；詳見私隱政策。廣告與你的 Freelancer 服務費無關，亦不是成交抽成。",
          },
        ],
      },
      "zh-TW": {
        ...
        sections: [
          ...
          {
            h: "廣告",
            p: "網站可能顯示第三方廣告，與接案服務費無關。詳見隱私權政策。",
          },
        ],
      },
      "zh-Hans": {
      ...
      en: {
        ...
        sections: [
          ...
          {
            h: "Ads",
            p: "Some web pages may show third-party ads. They are unrelated to your freelance fees—see the Privacy Policy.",
          },
        ],
      },
    },

    ...
    copy: {
      ...
      "zh-TW": {
        ...
        sections: [
          ...
          {
            h: "廣告",
            p: "網站可能顯示 Google AdSense 廣告，與接案服務費無關。詳見隱私權政策。",
          },
        ],
      },
      "zh-Hans": {
        ...
        sections: [
          ...
          {
            h: "广告",
            p: "网站可能显示 Google AdSense 广告，与服务费无关。详见隐私政策。",
          },
        ],
      },
      en: {
        ...
        sections: [
          ...
          {
            h: "Ads",
            p: "Some web pages may show Google AdSense ads. They are unrelated to your freelance fees—see the Privacy Policy.",
          },
        ],
      },
    },
